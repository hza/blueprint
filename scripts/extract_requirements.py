...
Usage:
    ...
    python scripts/extract_requirements.py --rfp "RFP/AI-Powered Customer Facing Portal - RFP.md" --output output/FL.md
"""
...
def main() -> None:
    ...
    parser.add_argument("--rfp", default="RFP/AI-Powered Customer Facing Portal - RFP.md", help="Path to RFP markdown file")
