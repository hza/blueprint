      ...
      <div className="overview-banner">
        ...
        <div className="overview-banner-stats">
          ...
          <div className="overview-stat">
            ...
            <span className="overview-stat-value overview-val--danger">3 (only 1 ready)</span>
          </div>
          <div className="overview-stat">
        ...
        <div className="overview-card">
          ...
          <table className="overview-table">
            <tbody>
              ...
              <tr>
                <td className="overview-table-label">Delivery Outcome</td>
                <td><span className="overview-badge overview-badge--ok">ON TIME</span> <span className="overview-badge overview-badge--warn">+$80K SCOPE</span></td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="overview-card">
          ...
          <table className="overview-table">
            <tbody>
              ...
              <tr>
                <td className="overview-table-label">Awards</td>
              ...
              <tr>
                <td className="overview-table-label">Staff</td>
              ...
              <tr>
                <td className="overview-table-label">Financial Stability</td>
